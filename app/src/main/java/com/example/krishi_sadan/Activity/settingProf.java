...
public class settingProf extends AppCompatActivity {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                             storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                 ...
                                 public void onSuccess(Uri uri) {
                                     ...
                                     Users users = new Users(auth.getUid(), name, email, phoneno, finalImageUri , status);
                                     reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                         @Override
                                         public void onComplete(@NonNull Task<Void> task) {
                                             if(task.isSuccessful()) {
                                                 Toast.makeText(settingProf.this, "Data Suscessfully updated", Toast.LENGTH_SHORT).show();
                                                 startActivity(new Intent(settingProf.this, ChatActivity.class));
                                             }
                                             else
                                             {
                                                 Toast.makeText(settingProf.this, "Something went wrong ", Toast.LENGTH_SHORT).show();
                                             }
